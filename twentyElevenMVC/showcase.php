...
wp_enqueue_script( 'twentyeleven-showcase', mvc_get_template_dir() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				<?php
					 ...
					 */
					if ( '' != get_the_content() )
						get_template_part( 'views/pages/content', 'intro' );
				?>
				...
				<?php
					...
					<section class="featured-post <?php echo $feature_class; ?>" id="featured-post-<?php echo $counter_slider; ?>">
						...
						?>
						<?php get_template_part( 'views/pages/content', 'featured' ); ?>
					</section>
				<?php endwhile;	?>
				...
				<section class="recent-posts">
					...
					if ( $recent->have_posts() ) : $recent->the_post();
						...
						get_template_part( 'views/content', 'view' );
